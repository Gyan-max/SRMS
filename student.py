...
class StudentClass:
    def __init__(self, root):
        ...
        # ========Widgets========
        lbl_roll_no = Label(self.root, text="Roll No", font=("times new roman", 15, "bold"), bg="white").place(x=10, y=60, width=120, height=30)
        lbl_date_of_birth = Label(self.root, text="D.O.B (DD/MM/YYYY)", font=("times new roman", 13, "bold"), bg="white").place(x=350, y=60, width=150, height=30)
        lbl_name = Label(self.root, text="Name", font=("times new roman", 15, "bold"), bg="white").place(x=10, y=110, width=120, height=30)
        lbl_contact = Label(self.root, text="Contact", font=("times new roman", 15, "bold"), bg="white").place(x=350, y=110, width=150, height=30)
        lbl_email = Label(self.root, text="Email", font=("times new roman", 15, "bold"), bg="white").place(x=10, y=160, width=120, height=30)
        lbl_admission = Label(self.root, text="Admission", font=("times new roman", 15, "bold"), bg="white").place(x=350, y=160, width=150, height=30)
        lbl_gender = Label(self.root, text="Gender", font=("times new roman", 15, "bold"), bg="white").place(x=10, y=210, width=120, height=30)
        lbl_course = Label(self.root, text="Course", font=("times new roman", 15, "bold"), bg="white").place(x=350, y=210, width=150, height=30)
        lbl_address = Label(self.root, text="Address", font=("times new roman", 15, "bold"), bg="white").place(x=10, y=260, width=120, height=30)

        # ========Entry Fields========
        self.txt_roll_no = Entry(self.root, textvariable=self.var_roll_no, font=("times new roman", 15), bg="lightyellow")
        self.txt_roll_no.place(x=140, y=60, width=200, height=30)
        self.txt_date_of_birth = Entry(self.root, textvariable=self.var_date_of_birth, font=("times new roman", 15), bg="lightyellow")
        self.txt_date_of_birth.place(x=510, y=60, width=180, height=30)
        self.txt_name = Entry(self.root, textvariable=self.var_name, font=("times new roman", 15), bg="lightyellow")
        self.txt_name.place(x=140, y=110, width=200, height=30)
        self.txt_contact = Entry(self.root, textvariable=self.var_contact, font=("times new roman", 15), bg="lightyellow")
        self.txt_contact.place(x=510, y=110, width=180, height=30)
        self.txt_email = Entry(self.root, textvariable=self.var_email, font=("times new roman", 15), bg="lightyellow")
        self.txt_email.place(x=140, y=160, width=200, height=30)
        self.txt_admission = Entry(self.root, textvariable=self.var_admission, font=("times new roman", 15), bg="lightyellow")
        self.txt_admission.place(x=510, y=160, width=180, height=30)
        self.txt_gender = ttk.Combobox(self.root, textvariable=self.var_gender, values=("Select Gender", "Male", "Female", "Other"), font=("times new roman", 15), background="lightyellow", state="readonly", justify=CENTER)
        self.txt_gender.place(x=140, y=210, width=200, height=30)
        self.txt_gender.current(0)
        self.course_list = []
        self.txt_course = ttk.Combobox(self.root, textvariable=self.var_course, values=self.course_list, font=("times new roman", 15), background="lightyellow", state="readonly", justify=CENTER)
        self.txt_course.place(x=510, y=210, width=180, height=30)
        self.txt_address = Text(self.root, font=("times new roman", 15), bg="lightyellow", wrap=WORD)
